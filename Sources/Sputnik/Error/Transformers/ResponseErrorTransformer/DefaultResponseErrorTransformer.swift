...
/// The default error transformer. This will always be set as the erros handler unless you explicitly change it to a different one
...
class DefaultResponseErrorTransformer<T>: ResponseErrorTransformer where T: ResponsePartialError {
    ...
    /// Used when the response return data and errors together. Transfors the "errors" into an array of [ResponseParialErrors].
