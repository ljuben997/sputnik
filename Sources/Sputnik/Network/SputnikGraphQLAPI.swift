...
public protocol SputnikGraphQLAPI {
    ...
    /// declare it in the API defintion. You can also use the DefaultResponseErrorTransformer but add a different generic value if you want the
    /// transformer to return a different objec. The logic for transofrming it however will be the same.
