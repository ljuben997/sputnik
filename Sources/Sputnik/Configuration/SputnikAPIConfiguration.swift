...
public class SputnikAPIConfiguration {
    ...
    /// Sets the network mode globaly for the default configuration. Use this in your app's startup configuration to set the mode.
    @MainActor
    public static func setNetworkMode(_ mode: NetworkMode) {
        defaultConfiguration.mode = mode
    }

    /// Sets the debug configuration globaly for the default configuration. Use this in your app's startup configuration to set the debug configuration.
    @MainActor
